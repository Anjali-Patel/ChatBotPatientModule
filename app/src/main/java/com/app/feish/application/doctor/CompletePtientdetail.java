...
public class CompletePtientdetail extends AppCompatActivity
{
    ...
    private Request listpre() {
        ...
        return new Request.Builder()
                ...
                .url(ApiUtils.BASE_URL2+"listprescrption")
                .post(body)
                .build();
    ...
    private Request updateappodetail() {
        ...
        return new Request.Builder()
                .addHeader("X-Api-Key", "AB5433GMDF657VBB")
                .addHeader("Content-Type", "application/json")
                .url(ApiUtils.BASE_URL2+"updatedatafromdoctor")
                .post(body)
                .build();
...
//Event triggered when the pad is cleared
    ...
    private Request listpharmacy() {
        ...
        return new Request.Builder()
                .addHeader("X-Api-Key", "AB5433GMDF657VBB")
                .addHeader("Content-Type", "application/json")
                .url(ApiUtils.BASE_URL2+"listPharmacy")
                .post(body)
                .build();
    }
    ...
    private Request AddSoapnote()
    {
        ...
        return new Request.Builder()
                .addHeader("X-Api-Key", "AB5433GMDF657VBB")
                .addHeader("Content-Type", "application/json")
                .url(ApiUtils.BASE_URL2+"createsoapnoteandpres")
                .post(body)
                .build();
    }
