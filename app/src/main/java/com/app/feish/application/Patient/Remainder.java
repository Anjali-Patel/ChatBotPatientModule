...
import com.app.feish.application.fragment.Addreminder;
import com.app.feish.application.fragment.ListAllreminder;
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0: // Fragment # 0 - This will show FirstFragment
                    return Addreminder.newInstance(drnote,"Institute");
                case 1: // Fragment # 0 - This will show FirstFragment different title
                    return ListAllreminder.newInstance(drnote,"Institute");
                default:
                    return null;
            }
        }
