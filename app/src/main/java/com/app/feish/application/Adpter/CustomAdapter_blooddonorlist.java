...
import com.app.feish.application.Patient.PatientMessageActivity;
import com.app.feish.application.Patient.Patientidemessagefragment;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_send.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent= new Intent(context, PatientMessageActivity.class);
                        context.startActivity(intent);
                      /*  Patientidemessagefragment optionsFrag = new Patientidemessagefragment ();
                        ((PatientMessageActivity)context).getSupportFragmentManager().beginTransaction().replace(R.id.container, optionsFrag,"").addToBackStack(null).commit();*/
...
////                        intent.putExtra("user_id",list.get(position).getCommunication().getUserId());
////                        intent.putExtra("name",dataSet.get(listPosition).getUser().getFirstName());
//
////                        intent.putExtra("my_id",list.get(position).getCommunication().getRecieverUserId());
//                        intent.putExtra("name",list.get(position).getDr_name());
////                        intent.putExtra("lastname",list.get(position).getUser().getLastName());
////                        intent.putExtra("msg_type",list.get(position).getFlag());
//                       context.startActivity(intent);
    ...
    private Request msgtodoc_request(String subject,String message,String Userid) {
        ...
        final Request request = new Request.Builder()
                ...
                .url(BASE_URL2+"communicateToPatient")
                .post(body)
                .build();
