...
public class Addreport extends Fragment {
  ...
  EditText editText,et_testdate;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        spinner_testlist.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                        ethinicity.setText(arg0.getSelectedItem().toString());
                        ...
                        spinner_testlist.setText(doctormsglists.get(position).getName());
