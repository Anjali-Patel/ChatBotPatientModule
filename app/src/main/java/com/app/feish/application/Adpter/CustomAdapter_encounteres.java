...
public class CustomAdapter_encounteres extends RecyclerView.Adapter<CustomAdapter_encounteres.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final CustomAdapter_encounteres.MyViewHolder holder, @SuppressLint("RecyclerView") final int listPosition) {
...
/*            else
    ...
    private Request family_his(int pos,int stausvalue) {
        ...
        return new Request.Builder()
                ...
                .url(ApiUtils.BASE_URL2+"UpdateBookAppointment")
                .post(body)
                .build();
    ...
    private Request fetchdoctokenid(int pos) {
        ...
        return new Request.Builder()
                .addHeader("X-Api-Key", "AB5433GMDF657VBB")
                .addHeader("Content-Type", "application/json")
                .url(ApiUtils.BASE_URL2+"fetchTokenIDfornotification")
                .post(body)
                .build();
