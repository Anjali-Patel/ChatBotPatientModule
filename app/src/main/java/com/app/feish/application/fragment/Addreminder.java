...
ProgressDialog progressDialog;
    ...
    public static Fragment newInstance(int page, String title) {
        Addreminder fragmentFirst = new Addreminder();
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if (jsonObject.getInt("Success") == 1) {
                                ...
                                Toast.makeText(getActivity(), "Add Reminder", Toast.LENGTH_SHORT).show();
                            }
    ...
    private Request AddPatientnotes(String sub,String desc,String weekday,String monthdate,String hrsdeatil,String Date,String Time,String end_date)
    {
        String url="";
        if(drnote==0)
            url=ApiUtils.BASE_URL2+"PatientNotes";
            else
            url=ApiUtils.BASE_URL2+"DoctorNotes";
