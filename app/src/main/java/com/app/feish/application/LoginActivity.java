...
import com.app.feish.application.Patient.PrivacyPolicy;
//import com.app.feish.application.clinic.ClinicDashboard;
import com.app.feish.application.Patient.Welcome;
    ...
    public void initViews() {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.feish.health"));
        ...
        connectiondetector = new Connectiondetector(getApplicationContext());
      /* tv_assistentlogin.setOnClickListener(new View.OnClickL2istener() {
           @Override
           public void onClick(View v)
           {
                    ...
                    public void onResponse(final Response response) throws IOException {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (message.compareTo("Login done Successfully") == 0 && Integer.parseInt(loginResponse.getData().getIsActive()) == 1) {
 ...
 2 2 2222                                    finish();*/
    ...
    private Request login_request() {
        ...
        return new Request.Builder()
                .addHeader("X-Api-Key", "eZD20zUkFt0:APA91bGzzs4p6GSv_b0zfGa7X5FnsSsCLAo3ChRPpvwWODyTASygif7l-PqEytAcjLoJKmWXmDkmxDGEqVq5TOFNLFZwQvZ8YVKyLwEbBO92qoNfWlocGJ2-uTzyuUbomKXYgARMPYII")
