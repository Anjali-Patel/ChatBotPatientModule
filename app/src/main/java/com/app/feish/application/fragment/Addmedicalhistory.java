...
String str_mcon="",str_ctype="",str_cumedication="",str_date="",str_desc="";
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        spinner_mcond.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialog.show();
                CustomAdapter customAdapter = new CustomAdapter(getContext(),medicalconditionlists);
                ...
                search_item.addTextChangedListener(new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        ...
                        if (strText.length() != 0) {
                            ...
                            CustomAdapter arrayAdapter = new CustomAdapter( getContext(),medicalconditionlistsTemp);
                            listItem.setAdapter(arrayAdapter);
                            arrayAdapter.notifyDataSetChanged();
                        } else {
                            Toast.makeText(getContext(),"No match found",Toast.LENGTH_LONG).show();
                            CustomAdapter arrayAdapter = new CustomAdapter( getContext(),medicalconditionlists);
                            listItem.setAdapter(arrayAdapter);
                            arrayAdapter.notifyDataSetChanged();
                        }
...
//                        ethinicity.setText(arg0.getSelectedItem().toString());
                        spinner_mcond.setText(medicalconditionlists.get(position).getName());
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                str_cumedication=spinner_ys.getSelectedItem().toString().trim();
   ...
   //     getActivity().setTitle("CollegeName");
    ...
    private Request addingmedicalhistory() {
        ...
        return new Request.Builder()
                ...
                .url(ApiUtils.BASE_URL2+"addMadicalHistory")
                .post(body)
                .build();
...
//            jsonArrayrecord.put(postdatavalue);
    ...
    private Request fetchingmedicalcondition() {
        ...
        return new Request.Builder()
                .addHeader("X-Api-Key", "AB5433GMDF657VBB")
                .addHeader("Content-Type", "application/json")
                .url(ApiUtils.BASE_URL2+"listMedicalCondition")
                .post(body)
                .build();
