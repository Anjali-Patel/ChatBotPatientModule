...
public class BookedAppointmetDetail extends AppCompatActivity {
    ...
    public void open() {
        ...
        if (appointmentdatum.getService().getLogo() != null) {
            String a="http://feish.health/img/services/" + appointmentdatum.getService().getLogo();
//            "http://feish.online/img/services/" + appointmentdatum.getService().getLogo()
            Picasso.with(context).load(a).into(imageView_imgser);
        }
