...
public class ListFamilyhistory extends Fragment {
    ...
    private Request listfamily_his() {
        ...
        return new Request.Builder()
                ...
                .url(ApiUtils.BASE_URL2+"listFamilyHistory")
                .post(body)
                .build();
        ...
        search_family.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(strText.length() != 0) {
                    ...
                    customAdapter_vitalsigns= new CustomAdapter_familyhistory(getContext(), vitalsignlistsTemp);
                    listView.setAdapter(customAdapter_vitalsigns);
                    customAdapter_vitalsigns.notifyDataSetChanged();
                } else {
                    Toast.makeText(getContext(),"No match found",Toast.LENGTH_LONG).show();
                    customAdapter_vitalsigns= new CustomAdapter_familyhistory(getContext(), vitalsignlists);
                    listView.setAdapter(customAdapter_vitalsigns);
                    customAdapter_vitalsigns.notifyDataSetChanged();
                }
