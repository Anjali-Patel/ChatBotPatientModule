...
public class Listtreatement extends Fragment {
    ...
    private Request listfamily_his() {
        ...
        return new Request.Builder()
                ...
                .url(ApiUtils.BASE_URL2+"listTreatment")
                .post(body)
                .build();
  ...
  View view1;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        serach_treatment=view1.findViewById(R.id.serach_treatment);
        progressBar=view1.findViewById(R.id.progressBar);
        fetch();
        progressBar.setVisibility(View.VISIBLE);
        serach_treatment.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(strText.length() != 0) {
                    ...
                    for (int i = 0; i < vitalsignlists.size(); i++) {
                        if ( vitalsignlists.get(i).getName().toLowerCase().startsWith(strText.toLowerCase()) ) {
                            vitalsignlistsTemp.add( vitalsignlists.get(i));
                        }
                    }
                    customAdapter_vitalsigns= new CustomAdapter_listtreatement(getContext(), vitalsignlistsTemp);
                    listView.setAdapter(customAdapter_vitalsigns);
                    customAdapter_vitalsigns.notifyDataSetChanged();
                } else {
                    Toast.makeText(getContext(),"No match found",Toast.LENGTH_LONG).show();
                    customAdapter_vitalsigns= new CustomAdapter_listtreatement(getContext(), vitalsignlists);
                    listView.setAdapter(customAdapter_vitalsigns);
                    customAdapter_vitalsigns.notifyDataSetChanged();
                }
 ...
 class CustomAdapter_listtreatement extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.textView_re.setText("Start Date :");
        holder.textView_diname.setText("End Date :");
        ...
        rowView.findViewById(R.id.delete).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Delete Treatment")
                        .setMessage("Are you sure you want to delete treatment?")
     ...
     private Request AddVitalSignApp(int id)
     {
         ...
         return new Request.Builder()
                 .addHeader("X-Api-Key", "AB5433GMDF657VBB")
                 .addHeader("Content-Type", "application/json")
                 .url(ApiUtils.BASE_URL2+"deteleTreatmentHistory")
                 .post(body)
                 .build();
     }
