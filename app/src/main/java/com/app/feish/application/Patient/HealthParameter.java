...
public class HealthParameter extends AppCompatActivity {
    ...
    ImageView imageView_edit,profile_pic;
   ...
   private void initView()
   {
       ...
       Glide.with(HealthParameter.this).load( Prefhelper.getInstance(HealthParameter.this).getProfile_pic()).error(R.drawable.patienr).into(profile_pic);
